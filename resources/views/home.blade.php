                ...
                <div class="col-xxl-7">
                    <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                        <div class="profile bg-gradient-primary-to-secondary">
                            <img class="profile-img" src="{{ asset('assets/assets/profile.png') }}" alt="Profile Image" />
                            {{-- dots design left as is --}}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">My name is Md. Mahbubur Rahman and I help brands grow.</p>
                        <p class="text-muted">
